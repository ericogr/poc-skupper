...
*Idiomas: [English](README.md) · Português (pt-BR) — este arquivo.*
...
tráfego; ver `docs/ARCHITECTURE.pt-BR.md`.)
...
**[`docs/ARCHITECTURE.pt-BR.md`](docs/ARCHITECTURE.pt-BR.md)** (ou a
versão em inglês, [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md)), com um
diagrama Mermaid para cada um desses tópicos.
...
docs/            ARCHITECTURE.md / ARCHITECTURE.pt-BR.md (diagramas Mermaid)
